                ...
                <div class="col-sm-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Consultez la liste des livres disponibles à l'emprunt, leurs
                                informations et modifiez leurs caractéristiques.</p>
                ...
                <div class="col-sm-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Consultez les commentaires et supprimez les si vous en ressentez le besoin.</p>
                            <RouterLink :to="{ name: 'adminCommentsList' }" class="btn btn-primary">Consulter</RouterLink>
                        </div>
                    </div>
                </div>
            </div>
